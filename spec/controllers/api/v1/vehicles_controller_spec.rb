...
RSpec.describe "Api::V1::Vehicles", type: :request do
  ...
  describe "GET /api/v1/vehicles/:id" do
    context "when viewing a specific vehicle that exists" do
      before { get "/api/v1/vehicles/#{vehicle.id}", headers: { Authorization: "Bearer #{customer_token.token}" }, as: :json }
  ...
  describe "POST /api/v1/vehicles" do
    ...
    context "when authenticated as a driver" do
      context "and providing valid vehicle details" do
        before { post "/api/v1/vehicles", params: valid_params, headers: { Authorization: "Bearer #{driver_token.token}" }, as: :json }
      ...
      context "and providing invalid vehicle details" do
        before { post "/api/v1/vehicles", params: invalid_params, headers: { Authorization: "Bearer #{driver_token.token}" }, as: :json }
    ...
    context "when using a client application token" do
      before { post "/api/v1/vehicles", params: valid_params, headers: { Authorization: "Bearer #{client_token.token}" }, as: :json }
    ...
    context "when authenticated as a customer" do
      before { post "/api/v1/vehicles", params: valid_params, headers: { Authorization: "Bearer #{customer_token.token}" }, as: :json }
